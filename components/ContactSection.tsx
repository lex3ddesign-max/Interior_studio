          ...
          <div>
            <TextReveal>
              <Title className="display-title max-w-xl">
                Начнём с материалов и спокойно оценим задачу
              </Title>
              <p className="mt-7 max-w-lg leading-7 text-muted">
                Пришлите планы, референсы, ссылку на материалы или просто коротко
                опишите задачу. Мы посмотрим, что уже готово для визуализации,
                что нужно уточнить и какой формат кадров будет работать лучше.
              </p>
            </TextReveal>
